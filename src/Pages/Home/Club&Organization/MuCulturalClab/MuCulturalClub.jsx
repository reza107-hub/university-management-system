  ...
  return (
    <div>
      ...
      <div className="w-[70%] mx-auto border border-gray-700 my-4 p-4 rounded-md space-y-6">
        ...
        <p className="font-bold text-xl">Advisors Panel</p>
        <p>
          Shumana Aziz <br />
          Deputy Director (PR)
        </p>
        <p>
          Miah Md. Asaduzzaman <br />
          Assistant Professor, Department Of EEE
        </p>
        <p>
          Mr. Gazi Saiful Hasan <br />
          Head Department of Law & Justice
        </p>
        <p>
          Dr. Rama Islam <br />
          Associate Professor, Department of English
        </p>
        <p className="font-bold text-xl">Member of the Committee</p>
        <p>
          ...
          Instrument Adviser, Sajon Chanda Sagor, ENG-46, 191-114-047 <br />
          Instrument Co-Ordinator, Raj Komol Deb CSE-56A,ID-221-115-040 <br />
        ...
        <p className="font-bold text-xl">Executive Members</p>
        <p>
          Saruar Mia, Law & Justice, Batch: 44, 201-113-006 <br />
          Puspita Das Mim, English, 52 batch, 221-114-032 <br />
          Keya Kormoker, Economics, 201-111-011, <br />
          Rajon Talukdar, SE- 02, 213-134-004 <br />
          Ravina Begum, BBA-50 <br />
          GM Sifat Iqbal, EEE-47 <br />
          Sadia Afroz Zafrin, CSE -55th, ID: 213-115-020 <br />
          Arnab Chowdhury, CSE -56, 221-115-068
        </p>
      </div>
    </div>
  );
