export const overviewData = [
  ...
  {
    question: 'INSTITUTES, SCHOOLS & DEPARTMENTS',
    answer: [
      ...
      'For now we will only see the 🏫<span><a href=\'/\' class="font-semibold text-black-700">School of Science & Technology:</a></span>',
      '🏫<span><a href=\'/\' class="underline font-semibold text-blue-600">School of Science & Technology:</a></span>',
      'There are the departments under the School of Science & Technology viz.',
      '🏫<span><a href=\'/\' class=" font-semibold text-blue-600">Department of Computer Science & Engineering (CSE)</a></span><br><br>🏫<span><a href=\'/\' class="font-semibold text-blue-600">Software Engineering</a></span><br><br>🏫<span><a href=\'/\' class="font-semibold text-blue-600">Department of Electrical & Electronic Engineering (EEE)</a></span>',
    ],
  },
  {
    question: 'DEPARTMENTS & DEGREE PROGRAMMES:',
    answer: [
      'At the very outset, it needs to be noted that we offer our undergraduate and graduate degree on a full time basis yet in a flexible manner. Every trimester students can take courses according to their choices, likings, and preferences. We hold weekend classes for the students who do jobs or other income generating works. This flexibility allows our students continue their education while earning their livelihoods. At present, the university offers the following degree programmes:<br><br>🏫<span><a href=\'/\' class=" font-semibold text-blue-600">Department of Computer Science & Engineering :</a></span><br><br>This department offers the  🏫<span><a href=\'/\' class=" font-semibold text-blue-600">B.Sc. Engineering in Computer Science & Engineering (CSE)</a></span><br><br>🏫<span><a href=\'/\' class=" font-semibold text-blue-600">Department of Software Engineering :</a></span><br><br>This department offers the  🏫<span><a href=\'/\' class=" font-semibold text-blue-600">B.Sc. Engineering in Software Engineering (SE)</a></span><br><br>🏫<span><a href=\'/\' class=" font-semibold text-blue-600">Department of Electrical & Electronic Engineering:</a></span><br><br>The  🏫<span><a href=\'/\' class=" font-semibold text-blue-600">B.Sc. in Electrical & Electronic Engineering (EEE)</a></span> is being offered from the 🏫<span><a href=\'/\' class=" font-semibold text-blue-600">Department of Electrical & Electronic Engineering.</a></span>',
    ],
  },
  {
    question: 'FACULTY MEMBERS & SUPPORT STAFF:',
    answer: [
      '<span><a href=\'/\' class=" font-semibold text-blue-600">Department of Computer Science & Engineering:</a></span>',
      "<table class='table-auto w-full border-collapse border border-gray-800'><thead><tr><th class='border border-gray-800 px-6 py-3 bg-gray-200 text-gray-700 font-semibold text-left'>Position</th><th class='border border-gray-800 px-6 py-3 bg-gray-200 text-gray-700 font-semibold text-left'>Number</th></tr></thead><tbody><tr><td class='border border-gray-800 px-6 py-4'>Professor</td><td class='border border-gray-800 px-6 py-4'>03</td></tr><tr><td class='border border-gray-800 px-6 py-4'>Associate Professor</td><td class='border border-gray-800 px-6 py-4'>N/A</td></tr><tr><td class='border border-gray-800 px-6 py-4'>Assistant Professor</td><td class='border border-gray-800 px-6 py-4'>06</td></tr><tr><td class='border border-gray-800 px-6 py-4'>Senior Lecturer</td><td class='border border-gray-800 px-6 py-4'>04</td></tr><tr><td class='border border-gray-800 px-6 py-4'>Lecturer</td><td class='border border-gray-800 px-6 py-4'>16</td></tr></tbody></table>",
      '<span><a href=\'/\' class=" font-semibold text-blue-600">Department of software Engineering:</a></span>',
      "<table class='table-auto w-full border-collapse border border-gray-800'><thead><tr><th class='border border-gray-800 px-6 py-3 bg-gray-200 text-gray-700 font-semibold text-left'>Position</th><th class='border border-gray-800 px-6 py-3 bg-gray-200 text-gray-700 font-semibold text-left'>Number</th></tr></thead><tbody><tr><td class='border border-gray-800 px-6 py-4'>Professor</td><td class='border border-gray-800 px-6 py-4'>03</td></tr><tr><td class='border border-gray-800 px-6 py-4'>Associate Professor</td><td class='border border-gray-800 px-6 py-4'>N/A</td></tr><tr><td class='border border-gray-800 px-6 py-4'>Assistant Professor</td><td class='border border-gray-800 px-6 py-4'>06</td></tr><tr><td class='border border-gray-800 px-6 py-4'>Senior Lecturer</td><td class='border border-gray-800 px-6 py-4'>04</td></tr><tr><td class='border border-gray-800 px-6 py-4'>Lecturer</td><td class='border border-gray-800 px-6 py-4'>16</td></tr></tbody></table>",
      '<span><a href=\'/\' class=" font-semibold text-blue-600">Department of Electrical & Electronic Engineering:</a></span>',
      "<table class='table-auto w-full border-collapse border border-gray-800'><thead><tr><th class='border border-gray-800 px-6 py-3 bg-gray-200 text-gray-700 font-semibold text-left'>Position</th><th class='border border-gray-800 px-6 py-3 bg-gray-200 text-gray-700 font-semibold text-left'>Number</th></tr></thead><tbody><tr><td class='border border-gray-800 px-6 py-4'>Professor</td><td class='border border-gray-800 px-6 py-4'>03</td></tr><tr><td class='border border-gray-800 px-6 py-4'>Associate Professor</td><td class='border border-gray-800 px-6 py-4'>N/A</td></tr><tr><td class='border border-gray-800 px-6 py-4'>Assistant Professor</td><td class='border border-gray-800 px-6 py-4'>06</td></tr><tr><td class='border border-gray-800 px-6 py-4'>Senior Lecturer</td><td class='border border-gray-800 px-6 py-4'>04</td></tr><tr><td class='border border-gray-800 px-6 py-4'>Lecturer</td><td class='border border-gray-800 px-6 py-4'>16</td></tr></tbody></table>",
  ...
  },
  {
    ...
    answer: [
      ...
      '<span class="font-bold">⚽MU Sports Club</span>',
      '<span class="font-bold">🪭MU Cultural Club</span>',
      '<span class="font-bold">💼MU Business Club</span>',
      '<span class="font-bold">⚖️MU Law Forum</span>',
      '<span class="font-bold">🩸MU Blood Donation Club</span>',
      '<span class="font-bold">🏃🏿‍♂️Rover Scout Group</span>',
      '<span class="font-bold">👨🏿‍✈️Leadership Development Forum</span>',
